...
\section{Sample Preparation}
    ...
    \subsection{Bars}
        ...
        Bars were then cut and sanded to final dimensions of \SI{3} x \SI{4} x \SI{25}{mm}.
    ...
    \subsection{Test Coupons}
        ...
        Tape casting was also used to create test coupons of porous SFCM-GDC ASL and SFCM-GDC/GDC half-cells.
