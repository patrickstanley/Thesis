...
\chapter[Flexural Strength and Flaw Distributions of \ce{SrFe_{0.2}Co_{0.4}Mo_{0.4}O_{3-\delta}} Based Ceramic-Supports for SOFCs at Operating Conditions]{Flexural Strength and Flaw Distributions of\\ \ce{SrFe_{0.2}Co_{0.4}Mo_{0.4}O_{3-\delta}} Based Ceramic-Supports for \\Solid-Oxide Fuel Cells at Operating Conditions}
...
\section{Results and Discussion}
    \subsection{Redox Cycling Stability}
        ...
        Previous experiments have shown that SFCM generates an impurity phase of \ce{Sr_2Co_{1.2}Mo_{0.8}O_6} under ambient and oxidizing conditions.\cite{Stanleya}
    ...
    \subsection{Strength of Anode Support Layer After Redox Cycling}
        ...
        \begin{table}
            \centering
            \caption{Summary of Cycled SFCM-GDC (2:1) \gls{asl} Mechanical Properties}
        ...
        \begin{figure}[p]
          ...
          \caption{Fitted Weibull distributions of SFCM-GDC (2:1) \gls{asl} before any cycling and after 10 redox cycles between 10\% H\textsubscript{2} and N\textsubscript{2}, plotted linearly with 95\% confidence intervals shaded}
          \label{fig:cycledweibull}
        \end{figure}

        \begin{table}
        \centering
        \caption{Summary of Weibull Fit Parameters (characteristic strength and Weibull modulus) for Cycled SFCM-GDC (2:1) \gls{asl}}
    ...
    \subsection{Half-cell Strength of Anode-Supported SOFCs at Operating Conditions}
        ...
        \begin{figure}[p]
          ...
          \caption{Flexural strengths of half-cell coupons made from SFCM-GDC (2:1) anode with GDC electrolyte placed in compression, tested at \SI{20}{\celsius} in air, \SI{600}{\celsius} in air, and \SI{600}{\celsius} in 5\% H\textsubscript{2}}
          \label{fig:InSituBox}
        \end{figure}

        \begin{table}
            \centering
            \caption{Summary of strengths for SFCM-GDC (2:1)/GDC half-cells at different environments}
            \label{tab:halfcell}
            \begin{tabular}{lllll}
        ...
        The fracture surfaces of samples tested at \temp{20} and \temp{600} in air are shown in Figure \ref{fig:FracSurf}.
        The low temperature fracture (\ref{fig:FracSurf}a) shows intergranular fracture though the majority of the \gls{asl}. Near the interface, the electrolyte posses transgranular fracture, which transitions back to intergranular fracture away from the interface.
        At higher temperature (\ref{fig:FracSurf}b) the fracture preferred the grain boundary more resulting in only intergranular fracture except for a few isolated spots in the electrolyte at the interface.


        \begin{figure}
          \includegraphics[width=5.0in]{RTFractureSurf.jpg}
          \includegraphics[width=5.0in]{HTFractureSurf.jpg}
        ...
        \begin{table}
            \centering
            \caption{Summary of Weibull fitting parameters (characteristic strength and Weibull modulus) for SFCM-GDC (2:1)/GDC half-cells at different environments}
