...
\chapter{Flexural strength and flaw distributions of \ce{SrFe_{0.2}Co_{0.4}Mo_{0.4}O_{3}} based ceramic-supports for solid-oxide fuel cells at operating conditions}
...
\section{Results and Discussion}
    \subsection{Redox Cycling Stability}
        ...
        \begin{figure}
          \includegraphics[width=3in]{CycleConductivity.jpg}
          \includegraphics[width=3in]{TGA.jpg}
        ...
        \begin{figure}
          \includegraphics[width=3in]{TGACycle.jpg}
          \includegraphics[width=3in]{CycleSummary.jpg}
    ...
    \subsection{Fracture Toughness}
        ...
        \begin{figure}
            \includegraphics[width=3in]{Kic.jpg}
          \includegraphics[width=3in]{ThermalExpansion.jpg}
    ...
    \subsection{Half-cell Strength of Anode-Supported SOFCs at Operating Conditions}
        ...
        \begin{figure}
          \includegraphics[width=5in]{halfcellstrength.png}
        ...
        \begin{figure}
          \includegraphics[width=4in]{insituweibull.png}
        ...
        \begin{figure}
          \includegraphics[width=2.0in]{RTFracture.jpg}
          \includegraphics[width=2.0in]{HTfracture.jpg}
          \includegraphics[width=2.0in]{ReduceFracture.jpg}
    ...
    \subsection{Strength of Anode Support Layer After Redox Cycling}
        ...
        \begin{figure}
          \includegraphics[width=3in]{0cycles.jpg}
          \includegraphics[width=3in]{10cycles.jpg}
