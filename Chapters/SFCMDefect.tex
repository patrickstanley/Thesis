...
\section{Results and Discussion}
    ...
    \begin{figure}
      \includegraphics[width=0.45\textwidth]{XRD.jpg}
    ...
    \begin{figure}
      \includegraphics[width=\textwidth]{conductivity.jpg}
    ...
    \begin{figure}
      \includegraphics[width=0.8\textwidth]{TPD.jpg}
    ...
    \begin{figure}
      \includegraphics[width=0.8\textwidth]{TGA600.jpg}
    ...
    \begin{figure}
      \includegraphics[width=\textwidth]{TGAtemps.jpg}
    ...
    \begin{figure}
      \includegraphics[width=\textwidth]{defect.jpg}
