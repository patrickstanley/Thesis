...
\section{Solid-Oxide Fuel Cell Operation}
    ...
    Historically, \glspl{sofc} operated near \temp{1000}, but advances in materials have allowed cells to decrease to the intermediate temperature range (\temp{650} to \temp{800}) and now the low temperature range below \temp{650}.\cite{Wachsman2011a}
...
\section{Solid-Oxide Fuel Cell Materials}
    ...
    Perovskite structures have yielded number of \glspl{miec} with potential uses as electrode materials. \cite{Yamamoto1987,Anderson1992,Ishihara2009}
