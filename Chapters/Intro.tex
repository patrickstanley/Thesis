...
During operation, oxygen vacancies are created by exposing the anode to an environment with a low partial pressure of oxygen (pO\subscript{2}), as shown in Equation \ref{eq:vacancyformation}.
...
New materials are being developed to serve the various functions within the cell.
