...
\section{Motivation for Solid-Oxide Fuel Cell Research}
    ...
    \glspl{sofc} are able to run on a variety of fuel sources, such as hydrogen, methane or even biogas.\cite{Park2000,Minh2004}
...
\section{Solid-Oxide Fuel Cell Operation}
    ...
    When the anode is exposed to fuel, it creates a low partial pressure of oxygen (pO\subscript{2}) in comparison to the cathode, which is exposed to air.
...
\section{Solid-Oxide Fuel Cell Materials}
    ...
    Nickel has traditionally been used as an anode material in \glspl{sofc}, due to its high conductivity and catalytic properties in combination with an ionic conductor such as \gls{gdc}. %citation would be good
    ...
    Examples of \gls{miec} ceramics are \ce{La_{\hbox{1--x}}Sr_{x}Cr_{\hbox{1--y}}Mn_{y}O_{3}}, \ce{Sr_{0.94}Ti_{0.9}Nb_{0.1}O_{3-\delta}}, \ce{Ba_{0.98}La_{0.02}SnO_3}, or \ce{Sr_{2}MgMoO_{6}}.\cite{Goodenough2007,Zha2005,Primdahl2001,Hussain2013,MohammedHussain2012,Hussain2016,Huang2006}.
    ...
    \Gls{ysz} is very stable, has a ratio of ionic conductivity to total conductivity (transference number) near 1, and good conductivity at temperatures in excess of \temp{800}.
    ...
    A lower transference number, as low as 0.9, allows a leakage current of electrons though the electrolyte, decreasing the current available though the external circuit.%check this number
    ...
    %Other materials, interconnects and seals
