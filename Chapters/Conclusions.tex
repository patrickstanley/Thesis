...
To develop a reliable, redox stable system, the phase purity and oxygen non-stoichiometry of a new ceramic anode material, \gls{sfcm}, was measured under oxidizing and reducing conditions at temperatures in the low temperature-\gls{sofc} range.
Under reducing conditions \gls{sfcm} is pure phase, but forms \ce{Sr_2Co_{1.2}Mo_{0.8}O_6} as an impurity under oxidizing conditions.
...
Oxygen desorbs from \Gls{sfcm} starting at \temp{350} and continues in excess of \temp{800}, enabling it to serve as an \gls{miec} below \temp{600}.
\Gls{sfcm} posses a low enthalpy of formation of oxygen vacancies (\SI{44.3}{\kilo\joule\per\mol}), allowing a large number of oxygen vacancies to form, up to a $\delta = 0.176$ at \temp{600} in 97\% H\textsubscript{2}.
...
\begin{itemize}
    ...
    \item Test other compositions of \gls{sfcm} to create pure phase material across \po2{}
    \item Perform X-ray photoelectron spectroscopy on \gls{sfcm} samples quenched from various \po2{}'s to measure changes in B-site oxidation states
    \item Determine a means to measure properties of \gls{sfcm} in intermediate and very high \po2{}'s
