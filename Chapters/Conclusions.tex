...
\chapter{Conclusions}
\section{Summary of Contributions}%Duplicate name, consider new one
...
\section{Future Work}
%Finite element analysis to model the results into a larger cell.
%Mitigation strategies, crack defection, pinning,
